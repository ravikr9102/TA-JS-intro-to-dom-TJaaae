...
allHrs.forEach((v) => v.style.border = "1px solid tomato");

// Change the background of all the hr to "antiquewhite" using for of loop.

allHrs.forEach((e) => e.style.backgroundColor = "antiquewhite");

// Change the 'border-radius' of all the hr to "5px" using array.

allHrs.forEach((v) => v.style.borderRadius = "5px");
...
let result = document.querySelectorAll('.image');

result.forEach((v) => v.style.border = "2px solid purple");
...
allHrs.forEach((v) => v.style.borderStyle = ('dashed'));
