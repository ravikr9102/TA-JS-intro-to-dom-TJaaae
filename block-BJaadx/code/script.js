...
allTopics.forEach((v) => console.log(v.innerText));
...
let firstWithId = document.getElementById('test');
...
let prvElmSibling = topics.previousElementSibling;
prvElmSibling.innerText = "Learning About Walking the DOM";

// 24. Select the first element child of the element stored in `topics` variable (#5) and change the `innerText` property of the element to `This is the first child element`.

let firstElmChild = topics.firstElementChild;
firstElmChild.innerText = "This is the first child element";

// 25. Select the last element child of the element stored in `topics` variable (#5) and log the `typeof` the element.

let lastElmChild = topics.lastElementChild;
console.log(`typeof ${lastElmChild}`);
